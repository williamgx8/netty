 ...
 */
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements
	Cloneable {

	//用于执行socket通信的线程组封装的EventLoopGroup
	...
	AbstractBootstrap(AbstractBootstrap<B, C> bootstrap) {
		...
		//synchronized用于防止其他线程堆options中内容的修改
		synchronized (bootstrap.options) {
			options.putAll(bootstrap.options);
		}
		//synchronized用于防止其他线程堆attrs中内容的修改
	...
	public ChannelFuture bind() {
		//绑定之前校验下EventLoopGroup和ChannelFactory
		validate();
		//校验本机地址
	...
	/**
	 * 创建Channel，初始化Channel，并将Channel注册到EventLoopGroup中
	 */
